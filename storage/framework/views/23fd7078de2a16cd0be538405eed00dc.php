    ...
    <div class="max-w-5xl mx-auto mt-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white border border-slate-200 rounded-xl p-6 mt-6 shadow space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-3 text-slate-700">
                <?php if(!empty($rental->measurement)): ?>
            ...
            <div class="space-y-2 text-slate-700">
                ...
                <?php if(!empty($rental->accommodation_type)): ?>
                    <div>
                ...
                <?php if(!empty($rental->application_type)): ?>
                    <div>
                ...
                <?php if(!empty($rental->nightsperweek)): ?>
                    <div>
...
<?php endif; ?><?php /**PATH C:\Users\moyak\final-year-project-gracemoore1\resources\views/student/listing-show.blade.php ENDPATH**/ ?>