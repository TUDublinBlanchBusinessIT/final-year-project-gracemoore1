...
<div class="page">
    ...
    <div class="card">
        ...
        <form method="POST" action="/student/register">
            ...
            <input type="date" name="dateofbirth" value="<?php echo e(old('dateofbirth')); ?>" required>
...
<?php /**PATH C:\Users\moyak\final-year-project-gracemoore1\resources\views/student/register.blade.php ENDPATH**/ ?>