...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <form id="ocrForm" method="POST" action="<?php echo e(route('landlord.verify.id.submit')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <a href="<?php echo e(route('landlord.verify.email')); ?>" class="back">← Back</a>
        </form>
    </div>
...
<?php /**PATH C:\Users\gmoor\final-year-project-gracemoore1\resources\views/landlord/verify-id.blade.php ENDPATH**/ ?>