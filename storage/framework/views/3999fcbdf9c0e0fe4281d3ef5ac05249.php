                        ...
                        <div class="mb-8 space-y-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($log->status !== 'resolved'): ?>
                                <div class="border-t border-slate-200 pt-4">
                                    ...
                                    <div class="mb-4">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($log->id, $requestedLogIds ?? [])): ?>
                                            <button
                                                type="button"
                                                disabled
                                        ...
                                        <?php else: ?>
                                            <a
                                                href="<?php echo e(route('landlord.service-request.create', $log->id)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\gmoor\final-year-project-gracemoore1\resources\views/landlord/maintenance-log.blade.php ENDPATH**/ ?>