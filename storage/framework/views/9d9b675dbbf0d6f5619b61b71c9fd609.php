...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Welcome to RentConnect, <?php echo e(session('admin_firstname') ?? 'Administrator'); ?>
    ...
    <div class="admin-dashboard-container">
        ...
        <div class="icon-row">
            <a href="<?php echo e(route('admin.reports')); ?>" class="icon-card">
            ...
            <a href="<?php echo e(route('admin.partnerships')); ?>" class="icon-card">
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
<?php endif; ?><?php /**PATH C:\Users\gmoor\final-year-project-gracemoore1\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>