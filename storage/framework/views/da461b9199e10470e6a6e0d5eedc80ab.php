    ...
    <div class="p-6 bg-white shadow rounded-lg">
        ...
        <table class="mt-4 w-full text-left text-sm">
            ...
            <tbody class="text-gray-800">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="border-b">

                        <td class="py-2"><?php echo e($s->id); ?></td>

                        <td class="py-2">
                            <?php echo e($s->firstname); ?> <?php echo e($s->surname); ?>

                        </td>

                        <td class="py-2"><?php echo e($s->email); ?></td>

                        <td class="py-2">
                            <a href="<?php echo e(route('admin.accounts.student.view', $s->id)); ?>"
...
<?php endif; ?><?php /**PATH C:\Users\gmoor\final-year-project-gracemoore1\resources\views/admin/student-accounts.blade.php ENDPATH**/ ?>