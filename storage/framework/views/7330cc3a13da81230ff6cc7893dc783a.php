     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-start justify-start">
            <div class="text-left">
                ...
                <div class="mt-1 font-semibold text-gray-800">Messages</div>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\gmoor\final-year-project-gracemoore1\resources\views/student/messages.blade.php ENDPATH**/ ?>