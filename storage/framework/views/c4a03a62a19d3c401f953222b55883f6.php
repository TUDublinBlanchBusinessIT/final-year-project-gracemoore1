...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <form id="verifyForm" method="POST" action="<?php echo e(route('landlord.verify.email.submit')); ?>">
            <?php echo csrf_field(); ?>
        ...
        <!-- Hidden resend form -->
        <form id="resendForm" method="POST" action="<?php echo e(route('landlord.verify.email.resend')); ?>" style="display:none;">
            <?php echo csrf_field(); ?>
            <input type="hidden" name="email" value="<?php echo e(request('email')); ?>">
            <button type="submit" style="background:#475569;">Send new code</button>
        </form>

        <a href="<?php echo e(route('landlord.register.show')); ?>" class="back">← Back</a>
    </div>
...
<?php /**PATH C:\Users\moyak\final-year-project-gracemoore1\resources\views/landlord/verify-email.blade.php ENDPATH**/ ?>