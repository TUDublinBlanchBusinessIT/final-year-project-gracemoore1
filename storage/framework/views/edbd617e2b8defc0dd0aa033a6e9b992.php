...
<div class="page">
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo e(route('landlord.register.store')); ?>">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="email" name="email" placeholder="example123@rentconnect.ie" value="<?php echo e(old('email')); ?>" required>
...
<?php /**PATH C:\Users\moyak\final-year-project-gracemoore1\resources\views/auth/landlord-register.blade.php ENDPATH**/ ?>