...
<div class="container">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <a href="<?php echo e(url('/')); ?>" class="back-btn">← Back to account selection</a>
    </form>
</div>

</body>
</html>
<?php /**PATH C:\Users\gmoor\final-year-project-gracemoore1\resources\views/auth/login.blade.php ENDPATH**/ ?>