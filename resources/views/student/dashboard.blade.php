<x-app-layout>
    ...
    {{-- Header: titles on the left, no duplicate hamburger --}}
    <x-slot name="header">
    ...
    <div>
        ...
        <div id="filterDrawer"
            ...
            <form class="space-y-4">
                ...
                {{-- Nights per Week (drawer UI only) --}}
                <div>
                ...
                @if ($countyListings->count() > 0)
                    ...
                    <div class="flex gap-4 overflow-x-auto pb-2 lg:hidden">
                        @foreach ($countyListings as $rental)
                            ...
                            <div class="min-w-[260px] bg-white rounded-xl border border-slate-200 shadow-sm p-4 hover:shadow-md transition">

                                {{-- NOT clickable: carousel only --}}
                                ...
                                {{-- CLICKABLE: text/details only --}}
                                <a href="{{ route('listing.show', $rental->id) }}" class="block mt-3 focus:outline-none focus:ring-2 focus:ring-blue-500 rounded">
    ...
    function updateCarousel(view, id) {
        ...
        // Ensure each slide fills container width
    ...
    function nextImage(view, id) {
        ...
        carouselState[key].index =
            (carouselState[key].index + 1) % count;
